...
/**
 * Parsed out of `attributes.ZONEINSTANCEID_s`, which Epic stores as a
 * JSON-encoded string on the session.
 */
export type MatchmakingZoneInstance = {
  theaterId: string
  theaterMissionId: string
  theaterMissionAlertId: string | null
}

export type MatchmakingTrackStatusPlayer = {
  id: string
