...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-8 w-full items-center justify-between rounded-lg border border-input [border-bottom-color:hsl(var(--control-stroke))] bg-background px-3 py-1 text-sm placeholder:text-muted-foreground disabled:opacity-50 [&>span]:line-clamp-1',
      className
    )}
    {...props}
  >
