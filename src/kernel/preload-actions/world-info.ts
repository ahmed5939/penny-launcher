...
export function requestHomeWorldInfo(accountId?: string) {
  ipcRenderer.send(ElectronAPIEventKeys.HomeWorldInfoRequest, accountId)
}

export function requestWorldInfoData(accountId?: string) {
  ipcRenderer.send(ElectronAPIEventKeys.WorldInfoRequestData, accountId)
}
